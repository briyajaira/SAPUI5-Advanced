            ...
            onSaveODataIncidence: function (channelId, eventId, data) {
                ...
                if (typeof incidenceModel[data.incidenceRow].IncidenceId == 'undefined') {
                    ...
                    this.getView().getModel("incidenceModel").create("/IncidentsSet", body, {
                        success: function () {
                            sap.m.MessageToast.show(orientation.getText("odataSaveOK"));
                        }.bind(this),
                        error: function (e) {
                            sap.m.MessageToast.show(orientation.getText("odataSaveKO"));
                        }.bind(this)
                    });
                } else {
                    sap.m.MessageToast.show(orientation.getText("odataNoChanges"));
                };
